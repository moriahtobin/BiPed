...
def Hybridforge(frame, seed, factor_, output):
    if frame.Has(seed):
        source = frame[seed]
#        energy = 0.
...
#            energy = source.energy
	...
	forged_particle.length = source.energy*factor_
...
tray.AddModule(Hybridforge,seed='Monopod', factor_=4.5, output='LongMuon')
tray.AddModule(Hybridforge,seed='Monopod',factor_=2.5, output='EqualMuon')
